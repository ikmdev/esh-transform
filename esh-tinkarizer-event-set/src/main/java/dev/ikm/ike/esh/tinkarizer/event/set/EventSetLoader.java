...
public class EventSetLoader extends AbstractLoader {

	Logger LOG = LoggerFactory.getLogger(EventSetLoader.class);
	...
	public EventSetLoader(String composerName, long time, UUID author, UUID module, UUID path) {
