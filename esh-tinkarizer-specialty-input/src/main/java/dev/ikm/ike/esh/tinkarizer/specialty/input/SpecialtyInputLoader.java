...
public class SpecialtyInputLoader extends AbstractLoader {

	Logger LOG = LoggerFactory.getLogger(SpecialtyInputLoader.class);
	...
	public SpecialtyInputLoader(String composerName, long time, UUID author, UUID module, UUID path) {
