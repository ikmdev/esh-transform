...
public class EventCodeLoader extends AbstractLoader {
	...
	public EventCodeLoader(String composerName, long time, UUID author, UUID module, UUID path) {
		super(composerName, time, author, module, path);
		init();
	}
	
	//Need to have this method here to ensure the EC Identifier Concept is created before any of the Event Code Concepts are created.
	private void init() {
